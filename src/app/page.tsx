import { getSeasonLeaderboard, getLeaderboard, getIngestedTournaments, getPreviousRanks, getSiteStats } from "@/lib/store";
...
export default async function Home() {
  const [year2, year1, year0, allTime, tournaments, previousRanks, siteStats] = await Promise.all([
